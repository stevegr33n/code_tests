...
var app = new _vue2.default({
  ...
  methods: {
    getAtomIssues: function getAtomIssues(url) {
    ...
    filterTitleOrState: function filterTitleOrState(option) {
      var _this = this;

      return this.issues.filter(function (issue) {
        var element = issue[option].toLowerCase();
    ...
    filterUser: function filterUser() {
      ...
      return this.issues.filter(function (issue) {
        ...
        var search = _this2.search.toLowerCase();
    ...
    filterLabels: function filterLabels() {
      ...
      return this.issues.filter(function (issue) {
        return issue.labels.find(function (label) {
    ...
    filterDate: function filterDate() {
      ...
      return this.issues.filter(function (issue) {
        var issueCreatedAt = _this4.formatDate(issue.created_at);
        var searchDate = _this4.search;
        return (0, _moment2.default)(issueCreatedAt).isAfter(searchDate);
      });
    },
  ...
  computed: {
    filteredIssues: function filteredIssues() {
      ...
      var option = this.filters.selectedOption;
      if (option === 'user') {
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(123).setImmediate))
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(125)))
