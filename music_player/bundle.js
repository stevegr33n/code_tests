...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__css_style_css__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data__ = __webpack_require__(129);





let data = Object(__WEBPACK_IMPORTED_MODULE_2__data__["a" /* getData */])()
...
function buildPlaylist() {
    const result = data.reduce((result, track) => {
        result += `<div id=${track.id} class="playlist">
                    ...
                    <div>${track.album}</div>
                    <div class="duration">${__WEBPACK_IMPORTED_MODULE_0_moment___default.a.utc(track.duration*1000).format('mm:ss')}</div>
                    </div>`
        return result
    }, '')
...
function updateTrackDuration(track) {
    ...
    interval = setInterval(function () {
        trackDuration -= 1
        duration.innerHTML = __WEBPACK_IMPORTED_MODULE_0_moment___default.a.utc(trackDuration * 1000).format('mm:ss')
        if (trackDuration == 0) {
...
function getData() {
    return [{
            ...
            albumArt: 'https://images-na.ssl-images-amazon.com/images/I/61fKEhv78vL._SY300_.jpg',
            duration: '280'
        },
        {
            id: 1,
            ...
            album: 'EP II',
            albumArt: 'https://f1.bcbits.com/img/a2385050808_2.jpg',
            duration: '194'
        },
        {
            id: 2,
            ...
            artist: 'Rammstein',
            album: 'Reise, Reise',
            albumArt: 'https://i.vimeocdn.com/portrait/4382596_300x300',
            duration: '283'
        }
    ]
}
